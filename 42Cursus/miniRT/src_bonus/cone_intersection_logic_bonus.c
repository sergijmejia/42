...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   cone_intersection_logic_bonus.c                    :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: rafaguti <rafaguti>                        +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/05/11 19:45:46 by rafaguti          #+#    #+#             */
/*   Updated: 2026/05/11 19:53:24 by rafaguti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param q Pointer to quadratic structure to store coefficients & discriminant
 * @return 1 if discriminant is non-negative and 'a' is non-zero, 0 otherwise
 */
...
int	hit_cone_side(t_vec ro, t_vec rd, t_rt_cone cn, double *out_t)
{
	...
	if (v1 && is_valid_u(ro, rd, cn, t2))
	{
		...
		*out_t = t1;
	else if (is_valid_u(ro, rd, cn, t2))
		*out_t = t2;
	else
		return (0);
	return (1);
